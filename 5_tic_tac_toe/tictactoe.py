...
class Player:
    def __init__(self, letter):
        #Letter is x or o
        self.letter = letter
    #We want all our players to be able to get their next move
...
class randomComputerPlayer(Player):
    def __init__(self, letter):
        super().__init__(letter) #removed the self keyword----
...
class geniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        for possible_move in state.available_moves():
            ...
            sim_score['position'] = possible_move # otherwise this will get messed up from the recurssion part
